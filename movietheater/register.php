      ...
      <div class="navbar-collapse collapse">
        <div class="menu">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" class="active"><a href="#">SINGN UP</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<div class="row">
  ...
  <div class="col-md-6 l-posts">
    <form action="registerlistener.php" method="post">
            <div class="form-group row login">
                <label for="full_name" class="col-md-3 col-form-label text-md-right">Name</label>
                <div class="col-md-9">
                    <input type="text" id="full_name" class="form-control" name="full_name" required autofocus>
                </div>
            </div>
            <div class="form-group row login">
                <label for="mobile_no" class="col-md-3 col-form-label text-md-right">Phone Number</label>
                <div class="col-md-9">
            ...
            <div class="form-group row login">
                ...
                <div class="col-md-9">
                    <input type="password" id="con-password" class="form-control" name="con-password" required>
                </div>
            </div>
