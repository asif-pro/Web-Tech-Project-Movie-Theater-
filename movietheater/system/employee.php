...
if(isLoggedIn()) {
    ...
    if(isAdmin($user)) {
        ...
        $__pageError = getTransfer("employeeError");
        $__pageSuccess = getTransfer("employeeSuccess");
            ...
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Do you really want to delete an Employee? This process cannot be undone.</p>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Showing All Employee From System
                                    <a href="employeeadd.php" class="btn btn-primary btn-xs pull-right">Add New</a>
                                </div>
                                <!-- /.panel-heading -->
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <?php $users = getUsersByRole("employee"); ?>
                                                <?php if(!empty($users)) : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= htmlspecialchars($__user['salary']) ?></td>
                                                    <td><?= htmlspecialchars($__user['designation']) ?></td>
                                                    <td><?= __formatDate($__user['registered'], "j F Y") ?></td>
                                                    <td>
                                                        <a href="editemployee.php?employee=<?= htmlspecialchars($__user['id']) ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>&nbsp; &nbsp;<a href="deleteemployee.php?employee=<?= htmlspecialchars($__user['id']) ?>" class="btn btn-danger btn-xs remove-confirm"><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                                <?php endforeach; ?>
                                                <?php else : ?>
                                                <tr>
