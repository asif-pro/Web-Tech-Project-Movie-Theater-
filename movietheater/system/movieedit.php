...
if(isLoggedIn()) {
    ...
    if(isEmployee($user)) {
        ...
        $__pageError = getTransfer("movieEditError");
        $__pageSuccess = getTransfer("movieEditSuccess");
        $__movieid = getTransfer("movieEditId");
        $__preData = getTransfer("movieEditData");
        $__preData = !empty($__preData) ? $__preData : array();

        $id = isset($_REQUEST['movie']) ? $_REQUEST['movie'] : $__movieid;
        
        if(!empty($id) && !empty($__movie =  getMovieById($id))) {

            $name = isset($__preData['name']) ? $__preData['name'] : $__movie['name'];
            $genre = isset($__preData['genre']) ? $__preData['genre'] : $__movie['genre'];
            $rating = isset($__preData['rating']) ? $__preData['rating'] : $__movie['rating'];
            $type = isset($__preData['movie_type']) ? $__preData['movie_type'] : ($__movie['type']=='1'?'upc':'now');
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" method="post" action="movieeditlistener.php" enctype="multipart/form-data">
                                      <div class="form-group">
                                        <label class="control-label col-sm-2" for="name">Name:</label>
                                        <div class="col-sm-10">
                                          <input type="text" class="form-control" name="name" id="name" value="<?= htmlspecialchars($name) ?>" placeholder="Enter Movie Name">
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label col-sm-2" for="genre">Genre:</label>
                                        <div class="col-sm-10">
                                          <input type="text" class="form-control" name="genre" id="genre" value="<?= htmlspecialchars($genre) ?>" placeholder="Enter Genre">
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label col-sm-2" for="rating">Rating:</label>
                                        <div class="col-sm-10">
                                          <input type="text" class="form-control" id="rating" name="rating" value="<?= htmlspecialchars($rating) ?>" placeholder="Enter IMDB Rating">
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="movie_type" id="movie_type" class="form-control">
                                                ...
                                                <option value="now"<?= $type=='now' ? " selected" : "" ?>>Now Showing</option>
                                                <option value="upc"<?= $type=='upc' ? " selected" : "" ?>>Upcomming</option>
                                            </select>
                                        </div>
                                      </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group acl-input-file" name="poster">
                                                ...
                                                <input type="text" class="form-control" id="poster" data-def="<?= htmlspecialchars($__movie['poster']) ?>" value="<?= htmlspecialchars($__movie['poster']) ?>" placeholder='Choose a file...' readonly />
                                                <span class="input-group-btn">
                                      ...
                                      <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            <input type="hidden" name="movie" value="<?= htmlspecialchars($__movie['id']) ?>">
                    ...
                    function() {
                        if ( ! $(this).prev().hasClass('input-hidden-acl') ) {
                            ...
                            $(this).find("button.btn-reset").click(function(){
                                ...
                                $(this).parent().hide();
                                $(this).parents(".acl-input-file").find('input').val( $(this).parents(".acl-input-file").find('input').data('def'));
                            });
